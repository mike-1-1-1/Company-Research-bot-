...
class CompanyResearchAgent(AgentCoreBase):
    ...
    def does_company_name_probably_exist(self, company_name: str) -> bool: #TODO: unit test this method
    ...
    def get_company_info(self, company_name: str, topic: str, time_frame: str) -> str:  #TODO: unit test this method
    ...
    def is_time_frame_valid(self, time_frame: str) -> bool:  #TODO: unit test this method
    ...
    def do_analysis_on_data_collections(self, data_collection_info: Dict[str, Any], analysis_type: str) -> str:  #TODO: unit test this method
    ...
    def generate_report(self, data_analysis_info: Dict[str, Any], report_style: str) -> str:  #TODO: unit test this method
